...
public class InventoryPage extends BasePage {
    private final By addToCartButtonLocator = By.cssSelector("#add-to-cart-sauce-labs-backpack");
    private final By cartIconLocator = By.cssSelector("#shopping_cart_container");
